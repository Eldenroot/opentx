...
enum ModuleSubtypeMulti {
  ...
  MODULE_SUBTYPE_MULTI_SPECTRUM_ANALYSER,
  MODULE_SUBTYPE_MULTI_FRSKY_RX,
  MODULE_SUBTYPE_MULTI_FLYSKY_RX,
  MODULE_SUBTYPE_MULTI_LAST = MODULE_SUBTYPE_MULTI_FLYSKY_RX
};
